...
Version  : 24.12.2
Release  : 78
URL      : https://download.kde.org/stable/release-service/24.12.2/src/kteatime-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kteatime-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kteatime-24.12.2.tar.xz.sig
...
%setup -q -n kteatime-24.12.2
cd %{_builddir}/kteatime-24.12.2
pushd ..
cp -a kteatime-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738951602
mkdir -p clr-build
pushd clr-build
...
/usr/share/doc/HTML/sl/kteatime/index.cache.bz2
/usr/share/doc/HTML/sl/kteatime/index.docbook
