...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kteatime-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kteatime-24.05.1.tar.xz.sig
...
%setup -q -n kteatime-24.05.1
cd %{_builddir}/kteatime-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718387846
mkdir -p clr-build
pushd clr-build
