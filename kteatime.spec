...
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/kteatime-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/kteatime-20.08.2.tar.xz.sig
...
%prep
%setup -q -n kteatime-20.08.2
cd %{_builddir}/kteatime-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602701384
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kteatime-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/kteatime/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kteatime-20.08.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kteatime/0c4be15f5177aafffe980ca09c0f4ca6ed741f43
pushd clr-build
%make_install
popd
%find_lang kteatime
